...
import { Menu, X, Facebook, Instagram, Mail, Phone, MapPin, ArrowRight } from 'lucide-react';
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-12">
            ...
            <Link
              to="/contato"
              onClick={() => trackEvent('simular_click')}
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-20 mb-32">
            ...
            <div className="md:col-span-5">
              ...
              <div className="flex space-x-6">
                <a href="#" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center text-white hover:bg-antares-cyan hover:text-antares-dark transition-all duration-500">
                  <Instagram size={20} />
                </a>
                <a href="#" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center text-white hover:bg-antares-cyan hover:text-antares-dark transition-all duration-500">
                  <Facebook size={20} />
            ...
            <div className="md:col-span-3">
              ...
              <ul className="space-y-6">
                <li><Link to="/sobre" className="text-gray-400 hover:text-white transition-colors">Sobre a Companhia</Link></li>
                <li><Link to="/servicos" className="text-gray-400 hover:text-white transition-colors">Soluções Corporativas</Link></li>
                <li><Link to="/projetos" className="text-gray-400 hover:text-white transition-colors">Estudos de Caso</Link></li>
                <li><Link to="/contato" className="text-gray-400 hover:text-white transition-colors">Central de Vendas</Link></li>
              </ul>
            </div>
