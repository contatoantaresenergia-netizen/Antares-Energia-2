...
export const CamaragibeProjects: React.FC = () => {
  ...
  const allProjects = [
  const allProjects = [
  { id: 1, title: 'Residência Lake View', cat: 'Residencial', power: '15 kWp', img: '...' },
  { id: 2, title: 'Centro Logístico PE', cat: 'Industrial', power: '500 kWp', img: '...' },
  { id: 3, title: 'Usina Solar Antares', cat: 'Industrial', power: '2 MW', img: '...' },
  { id: 4, title: 'Centro Automotivo Camaragibe', cat: 'Comercial', power: '45 kWp', img: '...' },
  { id: 5, title: 'Shopping Plaza Regional', cat: 'Comercial', power: '350 kWp', img: '...' },
  { id: 6, title: 'Estação de Carga EV', cat: 'Comercial', power: 'Mobility', img: '...' },
  { id: 7, title: 'Fazenda Solar PE', cat: 'Industrial', power: '1.5 MW', img: '...' },
  { id: 9, title: 'Indústria Têxtil Camaragibe', cat: 'Industrial', power: '150 kWp', img: '...' },
]; // ✅ FECHA AQUI
