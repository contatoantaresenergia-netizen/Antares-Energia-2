      ...
      <div className="bg-black py-24 mb-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            Nossa <span className="text-blue-400">História</span>
          </h1>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center mb-32">
          <div>
            ...
            <p className="text-gray-600 mb-10 text-lg leading-relaxed">
              Não vendemos apenas equipamentos; entregamos liberdade. Nossa engenharia é inspirada nos mais altos padrões globais.
            </p>
            ...
            <div className="grid grid-cols-2 gap-8 border-t border-gray-100 pt-10">
              ...
              <div>
                <span className="block text-5xl font-black text-blue-400 mb-2">SP/PE</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-1 mb-32 shadow-2xl">
          <div className="bg-black p-12 text-white border-b md:border-b-0 md:border-r border-white/5">
            ...
            <p className="text-gray-400 leading-relaxed">Acelerar a transição energética através de soluções premium.</p>
          </div>
          ...
          <div className="bg-black p-12 text-white">
            ...
            <p className="text-gray-400 leading-relaxed">Ser o padrão ouro em instalação fotovoltaica no Brasil.</p>
          </div>
        </div>
      </div>
    </div>
