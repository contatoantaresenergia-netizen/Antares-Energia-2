...
export const Camaragibe: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Iniciar animações apenas se os refs existirem
  ...
  return (
    <>
      ...
      <main className="bg-white">
        ...
        <section
          ref={heroRef}
          className="relative min-h-[90vh] flex items-center justify-center bg-[#1e293b] pt-32"
        >
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-6 text-center text-white">
            ...
            >
              <Target className="w-6 h-6" /> Solicitar Diagnóstico{' '}
        ...
        >
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="text-3xl md:text-5xl font-bold text-center mb-20 text-[#3b82f6]">
            ...
            <div className="grid md:grid-cols-3 gap-8" ref={cardsRef}>
              {[
                ...
                <div
                  key={idx}
                  className="bg-white p-10 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-start gap-6 hover:shadow-md transition-shadow"
                >
